  ...
  */
  ...
  (function () {
    ...
    function initAddToCartButtons() {
      const addToCartButtons = $$(".add_to_cart_button, .ajax_add_to_cart, .single_add_to_cart_button");
      addToCartButtons.forEach(button => {
        var _button$querySelector, _button$querySelector2;
        // Sauvegarder le texte original
        ((_button$querySelector = button.querySelector(".d-none.d-xl-inline")) == null ? void 0 : _button$querySelector.textContent) || "";
        ((_button$querySelector2 = button.querySelector(".d-inline.d-xl-none")) == null ? void 0 : _button$querySelector2.textContent) || "";

        // Écouter les clics sur le bouton
        on(button, "click", () => {
          // JUSTE AJOUTER LA CLASSE LOADING - LE CSS FAIT LE RESTE !
          button.classList.add("loading");
          console.log("✅ Classe loading ajoutée - le spinner CSS devrait apparaître");
        });
      });
      ...
      if (typeof jQuery !== "undefined") {
        jQuery(document.body).on("added_to_cart", function (e) {
          ...
          const clickedButton = document.querySelector(".add_to_cart_button.loading, .ajax_add_to_cart.loading");
          ...
          if (clickedButton) {
            ...
            setTimeout(() => {
              ...
              const desktopSpan = clickedButton.querySelector(".d-none.d-xl-inline");
              const mobileSpan = clickedButton.querySelector(".d-inline.d-xl-none");
