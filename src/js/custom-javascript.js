(function () {
	...
	function initSearch() {
		...
		const openSearch = () => {
			...
			console.log("Mobile:", isMobile, "Target dropdown:", targetDropdown?.id);
		...
		const replaceSubmitIcon = () => {
			// Desktop
			const desktopBtn = desktopDropdown?.querySelector(
			...
			// Mobile
			const mobileBtn = mobileDropdown?.querySelector(
				'form button[type="submit"]'
			);
